...
def make_image(payload: bytes, out_path: str, rings=6, sectors=36, size=1300, quality=95, connect_dots=False, connect_style='mesh', connect_thickness=2, connect_color=(0,200,255), bg_color=None, transparent=None, hide_ring=False):
    ...
    for angle_deg in (45, 135, 225, 315):
        ...
        draw.ellipse((x - marker_r, y - marker_r, x + marker_r, y + marker_r), fill=(255, 190, 20))
        draw.ellipse((x - marker_r // 2, y - marker_r // 2, x + marker_r // 2, y + marker_r // 2), fill=(200, 120, 10))
    ...
    try:
        logo_path = os.path.join(os.path.dirname(__file__), "HSBC.png")
