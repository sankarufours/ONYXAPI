...
def api_generate(req: GenerateRequest):
    try:
        b64 = generator.generate_png_base64(req.payload, rings=req.rings, sectors=req.sectors, size=req.size, quality=req.quality, connect_dots=False, transparent=req.transparent)
